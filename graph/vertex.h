...
namespace dynamic_graph_representation_learning_with_metropolis_hastings
{
    ...
    /**
     * @brief VertexEntry represents a structure that contains the vertex data - compressed edges, and sampler manager.
     */
    struct VertexEntry
    {
         ...
         */
        VertexEntry(const types::CompressedEdges& compressed_edges, dygrl::SamplerManager* sampler_manager)
            : compressed_edges(compressed_edges), sampler_manager(sampler_manager) {};
    };
    ...
    struct Vertex
    {
        ...
        using val_t = VertexEntry;     // value: compressed edges and metropolis hastings samplers
        using aug_t = types::Degree;   // augmentation: vertex degree

        using entry_t = std::pair<key_t, val_t>;  // vertex - <vertex id, {compressed-edges, MH samplers}>
